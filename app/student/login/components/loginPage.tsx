      ...
      <div className="w-full lg:w-1/2 p-4 sm:p-6 md:p-12 lg:p-24 flex flex-col justify-center bg-white">
        <div className="max-w-md mx-auto w-full">
          <div className="mb-8 lg:mb-12">
            ...
            >
              <h1 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3 text-gray-800">Welcome Student!</h1>
              <p className="text-gray-500 text-sm sm:text-base">Sign in to continue learning</p>
            </motion.div>
          </div>
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex justify-between items-center pt-3 mt-5">
                <Link href="/student/forgot-password" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">
          ...
          <div className="mt-10">
            <Button 
              variant="outline" 
              className="w-full py-4 sm:py-6 text-sm sm:text-base border-blue-600 rounded-lg hover:bg-blue-50 hover:border-blue-400 transition-all"
